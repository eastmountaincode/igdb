...
The 20.6 MB six-data-video FLAC stress test exposed a cross-frame binding failure after Instagram transcoding: all 2,827 chunk indexes were present, but transition frames could combine the index from one chunk with the payload and payload CRC from another. The original payload-only CRC accepted those hybrids, producing a final SHA-256 mismatch. New frames now include an additional CRC bound to both the chunk index and payload; old posts without it remain decodable. The exact retry recovered 2,827/2,827 chunks from six Instagram-transcoded videos and matched the source SHA-256 `4ef8e3befa24977f6390c4b8e94b9a810ad8d47c8ffbba8b3d21c8db2df10441`. Evidence: https://www.instagram.com/p/DbFJr-6CXEA/
